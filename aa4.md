...
If we visit `localhost:8080` and log in, we can see `%echo` listed as an app.  If we click through, however, nothing shows yet.  How do we make the connexion?
